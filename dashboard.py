...
/* =====================================================================
   INICIO — FUNDO PREMIUM LOGISTICA/TECNOLOGIA (bloco isolado, so visual)
   Nao mexe em dados, calculos, filtros, graficos, tabelas, KPIs ou
   estrutura — apenas acabamento estetico. Para remover, e so apagar
   tudo entre este comentario e o "FIM" mais abaixo.
   ===================================================================== */

/* Fundo fixo: mapa do Brasil em wireframe (SVG puro, sem foto), pontos
   luminosos com linhas de conexao simulando rede logistica, glow laranja
   sutil em algumas regioes e uma textura tecnologica (grade) bem discreta.
   Tudo com pointer-events:none para nunca atrapalhar cliques, e opacidade
   baixa para nao prejudicar a leitura do conteudo por cima. */
.stApp::after {
    content: "";
    position: fixed;
    inset: 0;
    ...
    background-position: 18% 20%, 82% 14%, 58% 72%, 24% 88%, center, center;
    background-size: 42% 42%, 36% 36%, 40% 40%, 32% 32%, 64px 64px, 64px 64px;
    background-image:
        radial-gradient(circle, rgba(245,158,11,0.10), transparent 70%),
        radial-gradient(circle, rgba(245,158,11,0.06), transparent 70%),
        radial-gradient(circle, rgba(253,186,116,0.08), transparent 70%),
        radial-gradient(circle, rgba(245,158,11,0.05), transparent 70%),
        repeating-linear-gradient(0deg, rgba(245,158,11,0.025) 0px, rgba(245,158,11,0.025) 1px, transparent 1px, transparent 64px),
        repeating-linear-gradient(90deg, rgba(245,158,11,0.025) 0px, rgba(245,158,11,0.025) 1px, transparent 1px, transparent 64px);
    animation: fundoPremiumRespirar 18s ease-in-out infinite alternate;
}
.stApp::before {
    background-image:
        radial-gradient(circle at 15% 10%, rgba(59,130,246,0.08), transparent 45%),
        radial-gradient(circle at 85% 85%, rgba(245,158,11,0.07), transparent 45%),
        url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 800 900'><path d='M310,40 C380,20 460,35 520,80 C580,60 650,90 690,150 C730,200 720,270 680,310 C720,360 730,430 690,480 C710,540 690,610 640,650 C650,700 610,760 550,790 C520,830 460,850 410,820 C360,850 300,830 280,780 C230,770 190,730 190,670 C140,650 110,590 130,530 C90,500 70,440 100,380 C70,330 80,260 130,220 C110,170 140,110 200,80 C230,50 270,50 310,40 Z' fill='none' stroke='rgb(245,158,11)' stroke-width='1.3' opacity='0.4'/><path d='M150,300 Q400,320 650,290' stroke='rgb(245,158,11)' stroke-width='0.6' fill='none' opacity='0.12'/><path d='M150,500 Q400,520 650,480' stroke='rgb(245,158,11)' stroke-width='0.6' fill='none' opacity='0.12'/><path d='M170,620 Q400,640 600,610' stroke='rgb(245,158,11)' stroke-width='0.6' fill='none' opacity='0.12'/><line x1='220' y1='260' x2='430' y2='480' stroke='rgb(245,158,11)' stroke-width='1' opacity='0.32'/><line x1='430' y1='480' x2='430' y2='650' stroke='rgb(245,158,11)' stroke-width='1' opacity='0.32'/><line x1='430' y1='480' x2='620' y2='280' stroke='rgb(245,158,11)' stroke-width='1' opacity='0.28'/><line x1='430' y1='650' x2='520' y2='620' stroke='rgb(245,158,11)' stroke-width='1' opacity='0.28'/><line x1='430' y1='650' x2='380' y2='760' stroke='rgb(245,158,11)' stroke-width='1' opacity='0.28'/><line x1='620' y1='280' x2='520' y2='620' stroke='rgb(253,186,116)' stroke-width='0.8' opacity='0.18'/><circle cx='220' cy='260' r='6' fill='rgb(253,186,116)' opacity='0.5'/><circle cx='430' cy='480' r='7' fill='rgb(253,186,116)' opacity='0.55'/><circle cx='430' cy='650' r='6' fill='rgb(253,186,116)' opacity='0.5'/><circle cx='620' cy='280' r='5' fill='rgb(253,186,116)' opacity='0.45'/><circle cx='520' cy='620' r='5' fill='rgb(253,186,116)' opacity='0.45'/><circle cx='380' cy='760' r='4' fill='rgb(253,186,116)' opacity='0.4'/></svg>");
    background-size: auto, auto, min(72vw, 860px) auto;
    background-position: 15% 10%, 85% 85%, center 48%;
    background-repeat: no-repeat, no-repeat, no-repeat;
    opacity: 0.85;
}
@keyframes fundoPremiumRespirar {
    0%   { opacity: 0.65; }
    50%  { opacity: 1; }
    100% { opacity: 0.7; }
}
...
/* Glassmorphism um pouco mais forte nos cards existentes — so acabamento,
   mesma posicao/conteudo/comportamento de sempre. */
.painel, .glass-box, .topo-header, .kpi-card-premium {
    backdrop-filter: blur(18px) saturate(1.12);
    -webkit-backdrop-filter: blur(18px) saturate(1.12);
    border-color: rgba(245,158,11,0.10);
    box-shadow: 0 10px 34px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.03);
}
.painel:hover, .glass-box:hover {
    border-color: rgba(245,158,11,0.22);
    box-shadow: 0 10px 34px rgba(0,0,0,0.5), 0 0 22px rgba(245,158,11,0.07);
    transition: border-color .35s ease, box-shadow .35s ease;
}
/* =====================================================================
   FIM — FUNDO PREMIUM LOGISTICA/TECNOLOGIA
   ===================================================================== */
</style>
